...
public class HotelRateAction2 extends DispatchAction {
    ...
    public ActionLocation listRate(ModuleMapping mapping, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            HotelRateDAO2 dao = new HotelRateDAO2(dbManager);
            List<HotelRateVO2> list = dao.getRateList();
    ...
    public ActionLocation saveRate(ModuleMapping mapping, HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String id = request.getParameter("id");
            if (id == null) {
                Date effDate = HotelRateVO2.dateFormat.parse(request.getParameter("effdate"));
