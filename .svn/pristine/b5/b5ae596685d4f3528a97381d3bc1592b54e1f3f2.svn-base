...
<head>
 ...
 <script language="javascript">
	function submitRate() {
		...
		frm.action = "<%=request.getContextPath()%>/perdiemRateAction.it?method=saveRate";
		frm.submit();
	}
 </script>
<body>
<% 
  ...
  PerdiemRateVO perdiemRate = (PerdiemRateVO) request.getAttribute("perdiemRate");
  if (perdiemRate == null) {
      perdiemRate = new PerdiemRateVO();
  }
%>
  ...
  <table width="100%"  border="1" cellpadding="3" cellspacing="0" bordercolor="#6595D6" style="border-collapse:collapse;" >
   <tr class="tr1">
       <td align='center' colspan='2'>
          <b> <i18n:message key="housekeeping_perdiemrate.title"/>
       </td>
     </tr>
     <tr>
       <td align="right">
         <i18n:message key="housekeeping_perdiemrate.region"/> : 
       </td>
       <td>
         <input type='text' name='location' size='20' maxLength='20' required="true" value="<%=perdiemRate.getRegion() == null ? "" : perdiemRate.getRegion()%>"
          <%=perdiemRate.getRegion() == null ? "" : "readonly"%>>
         (<font color="red">*</font>)
       </td>
     </tr>
     <tr>
       <td align="right">
         <i18n:message key="housekeeping_perdiemrate.titlegroup"/> : 
       </td>
       <td>
         <select name="titleGroup">
           ...
           %>
           <option value="<%=titleGroupId%>" <%=titleGroupId.equals(perdiemRate.getTitleGroup()) ? "selected" : ""%>><%=titleGroupName%></option>
           <%
           }
           %>
         </select>
     ...
     <tr>
       <td align="right">
         <i18n:message key="housekeeping_perdiemrate.rate"/> : 
       </td>
       <td>
         <input type='text' name='rate' size='5' maxLength='5' required="true" value="<%=perdiemRate.getRate() == 0 ? "" : Integer.toString(perdiemRate.getRate())%>"
