...
if("policy".equalsIgnoreCase(searchType)){
	%>
<a class=anchorSection name=anchor1 title=保单概要></a>
...
<div id="dialog" title="Message" sytle="display:none">
	<p  id="datamessage" style="color:red;display:none">NO DATA</p>
</div>
</body>
