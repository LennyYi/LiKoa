...
DHTMLgoodies_formTooltip.prototype = {
     ...
     * @public
     * 
     * Update on 2013-4-23 make sure the tip box within the right border
     */	
	getLeftPos : function(inputObj)
	{	  
	  var returnValue = inputObj.offsetLeft;
	  var inputWidth = inputObj.offsetWidth;
	  while((inputObj = inputObj.offsetParent) != null){
	  	if(inputObj.tagName!='HTML'){
	  ...
	  if((returnValue+inputWidth)>(document.body.clientWidth*0.8))returnValue=returnValue-this.tooltipWidth-20;
	  return returnValue;
	}
