...
<%
    ...
    PerDiemRateVO2 rate = (PerDiemRateVO2) request.getAttribute("rate");
...
<html>
<head>
<title>Edit Per Diem Rate</title>
...
function selectCity(event) {
    ...
    var currency = region == "A01" ? "RMB" : "USD";
...
function submitRate() {
    ...
    frm.action = "<%=ctxPath%>/perdiemRateAction2.it?method=saveRate";
    frm.submit();
};
</script>
</head>
...
<table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#6595D6" style="border-collapse: collapse;">
    <tr class="tr1">
        <td align='center' colspan='2'><i18n:message key="housekeeping_perdiemrate.title" /></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class='tr3' align='right'>Per Diem Rate (<font color="red">*</font>)</td>
