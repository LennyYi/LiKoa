...
<% 
  ...
  String saveStr = form.getSaveAlias();
  String submitStr = form.getSubmitAlias();
 ...
 <script language="javascript">
    ...
    function submitForm(){
       ...
       var param = "&formId="+frm.formId.value
                 ...
                 +frm.orgId.value+"&afterSaveUrl="+frm.afterSaveUrl.value+"&saveAlias="+frm.saveAlias.value+"&submitAlias="+frm.submitAlias.value;
...
<form name="myForm" method='Post'>
   ...
   <tr>
      <td style="WIDTH:30%" align='right' class="tr3">
         <i18n:message key="form_design.saveAlias"/> : 
       </td>
       <td style="WIDTH:70%">  
         <input type='text' name=saveAlias size='20' maxlength='50' title='<i18n:message key="form_design.saveAlias"/>' value='<%=(form.getSaveAlias().equalsIgnoreCase("null"))?"":form.getSaveAlias()%>'>
       </td>
     </tr>
  <tr>
      <td style="WIDTH:30%" align='right' class="tr3">
         <i18n:message key="form_design.submitAlias"/> : 
       </td>
       <td style="WIDTH:70%">  
         <input type='text' name=submitAlias size='20' maxlength='50' title='<i18n:message key="form_design.submitAlias"/>' value='<%=(form.getSubmitAlias().equalsIgnoreCase("null"))?"":form.getSubmitAlias()%>'>
       </td>
     </tr>
     <tr>
