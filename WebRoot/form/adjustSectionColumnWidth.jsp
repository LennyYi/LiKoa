...
<html>
<head>
 <title><i18n:message key="form_design.adjust_col_width"/></title>
 ...
 <script language="javascript">
    function saveSectionFieldOrder(){
       ...
       var url = "<%=request.getContextPath()%>/formManageAction.it?method=saveAdjustColumnWidth&formSystemId=<%=formSystemId%>&sectionId=<%=sectionId%>"
                 +returnString;
  ...
  <table width="100%"  border="1" cellpadding="3" cellspacing="0" bordercolor="#6595D6" style="border-collapse:collapse;" >
    ...
    <%}else{ 
    	...
    	while(it.hasNext()){
    		...
    		out.println("<tr>");
    		out.println("<td align='left'>"+I18NMessageHelper.getMessage("form_design.column_label")+":<b>"+field.getFieldLabel()+"</b></td>");
    		out.print("<td>"+I18NMessageHelper.getMessage("form_design.column_width")+":<input type='text' name='columnWidth||"+field.getFieldId()+"' ");
