  ...
  <script language="javascript">
    ...
    function submitReport(){
      ...
      var url = "<%=request.getContextPath()%>/reportManageAction.it?method=saveReportSection&reportSystemId="+document.all['reportSystemId'].value
                +"&sectionId="+sectionId+"&sectionType="+document.all['sectionType'].value+"&remarkSectionId="+document.all['remarkSectionId'].value
                +"&sectionRemark="+sectionName+"&type="+type+"&sectionUrl="+document.all['sectionUrl'].value+"&PageColCount="+document.all['PageColCount'].value;
...
<form name='testReport'>
   ...
   <table width="100%"  border="1" cellpadding="3" cellspacing="0" bordercolor="#6595D6" style="border-collapse:collapse;" >
       ...
       <td style="WIDTH:70%">
         <%if("new".equals(type)){%>
           <select name="sectionType" onchange="sectionTypeChange(this)">
            ...
            <option value="04" >Html Section</option>
         ...
         <%}else{%>
          <select name="sectionType1" onchange="sectionTypeChange(this)" disabled>
            ...
            <option value="04" <%=(section.getSectionType()!=null && "04".equals(section.getSectionType()))?"selected":""%>>Html Section</option>
     ...
     <tr>
       <td style="WIDTH:30%" align='right'>
         <i18n:message key="report_design.section_pagecolcount"/> : 
       </td>
       <td style="WIDTH:70%">  
       <input type='text' name='PageColCount' title='<i18n:message key="report_design.section_pagecolcount"/>'  size='40' length='200' value='<%=section.getPageColCount()==0?"":section.getPageColCount()%>'>
       </td>
     </tr>
     
     <tr>
       <td style="WIDTH:30%" align='right'>
         <i18n:message key="report_design.section_remarkSectionID"/> : 
       </td>
       <td style="WIDTH:70%">  
       <input type='text' name='remarkSectionId' title='<i18n:message key="report_design.section_remarkSectionID"/>'  size='40' length='200' value='<%=section.getRemakSection()==null?"":section.getRemakSection()%>'>
       </td>
     </tr>
     <tr>
