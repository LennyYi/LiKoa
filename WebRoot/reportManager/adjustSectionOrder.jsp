...
<%@page import="com.aiait.eflow.reportmanage.vo.ReportSectionVO,java.util.*" %>
...
<html>
<head>
 <title><i18n:message key="report_design.adjust_order"/></title>
 ...
 <script language="javascript">
    function saveSectionOrder(){
        var param = $.Form("myReport").serialize({ regTime:new Date().toGMTString()}); //get all param value
      	var url = "<%=request.getContextPath()%>/reportManageAction.it?method=saveAdjustSectionOrder&reportSystemId=<%=reportSystemId%>";
 ...
 <form name="myReport" method="post">
  <table width="100%"  border="1" cellpadding="3" cellspacing="0" bordercolor="#6595D6" style="border-collapse:collapse;" >
    ...
    %>
    <tr>
      <td><b><i18n:message key="report_design.report_has_no_sections"/></b></td>
    </tr>
    <%}else{ 
    	...
    	while(it.hasNext()){
    		...
    		out.println("<tr>");
    		out.println("<td align='left'>"+I18NMessageHelper.getMessage("report_design.section_name")+":<b>"+section.getSectionRemark()+"</b></td><input type='hidden' name='sectionId_"+section.getSectionId()+"' value='"
    				    +section.getSectionId()+"'>");
    		out.print("<td>"+I18NMessageHelper.getMessage("report_design.order_id")+" :<input type='text' name='orderId_"+section.getSectionId()+"' ");
