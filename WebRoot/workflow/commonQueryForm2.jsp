...
<table width="100%">
  <tr>
	 ...
	 <IFRAME frameBorder=0 id='iframeName' name="iframeName" scrolling="no" src="<%=request.getContextPath()%>/workflow/listCommonQueryForm.jsp" style="HEIGHT:100%;VISIBILITY:inherit;WIDTH:100%;Z-INDEX:1"></IFRAME>
	</td>
  </tr>
</table>
</FORM>
