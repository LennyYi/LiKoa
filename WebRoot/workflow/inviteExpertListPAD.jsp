...
<script language="javascript">
    function submitStaff(){
		...
		if(document.getElementById('reason').value!=""){
		   comments = formatStringAllChar(document.getElementById('reason').value);
		}
...
<table width="100%"  border="1" cellpadding="3" cellspacing="0" bordercolor="#6595D6" style="border-collapse:collapse;" >
   ...
   <TR>
    <TD align='right'  width=15%>Team </TD><TD  width=30% align='left'><select id="teamCode" onchange="document.getElementById('staffName').value = '';searchStaffList();">
         </select>    
	</TD>
   </TR>    
   <TR>
    <TD align='right'  width=15%>Staff Name</TD><TD width=30% align='left'><input type='text' id='staffName' size='30' maxLength='50' value='' />
    </TD>
   </TR> 
   <TR>
   ...
   <TR>
	 <TD style="WIDTH: 323px; HEIGHT: 21px" colspan="2" nowrap >
		...
		<SCRIPT type='text/javascript'>
           createMovableOptions("fromBox","toBox[]",450,100,'Please click and pick','Selected advisers');
       </SCRIPT>
	 </TD>
   </TR>
   <TR>
     ...
     <TD align='left' valign="middle"  width=30% >
       <textarea id="reason" name="reason" rows='4' cols='55' onKeyDown="javascript:textCounter(this,document.getElementById('textareaLimitLength'),'500')></textarea>
     </TD>
   </TR>
  <TR>
    <TD align='center' colspan="2">
