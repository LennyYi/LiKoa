...
function calculatePremium(nodeId,isSum){
	...
	{	
		...
		//var fnage =	24;
		//var fsPkgcode = 'CEBX1';
		//var fsPlancode = '002';//document.getElementsByName("MemPlan_id")[fnCurrentRow-1].value;
		
		// var sql = "SELECT SUM(PREMIUM) AS PREMIUM FROM Tprodprem WHERE pkgcode
		// ='CEB19' and plancode = '003' AND 27>=AGEMIN AND 27<AgeMax GROUP BY
		// PKGCODE, PLANCODE";
		var nPremium = 0;
...
function countPeopleByPlan(){
	...
	for(var i=1;i<trList.length;i++){
		...
		var pkgCode=jQuery(trList[i]).find('select[name="field_4_19"]').val();
