...
//	currentNodeId="2";	//debug
	//alert(currentNodeId);
	if(currentNodeId=="0" || currentNodeId=="1"){	//Request Proposal
		jQuery('#div3').closest('tr').hide();
		jQuery('#div3').closest('tr').prev().hide();
		jQuery('#div3').closest('tr').prev().prev().hide();
		jQuery("input[name='field_4_1']").eq(1).before("<br>");
		jQuery("input[name='field_4_1']").eq(2).before("<br>");
		jQuery("input[name='field_4_1']").eq(3).before("<br>");
		...
		jQuery("input[name='selectRefBtn']").eq(1).attr("value","Benefit Summary");	
		jQuery("input[name='selectRefBtn']").eq(1).attr("onclick","");
...
//		window.open ('Demo/ProposalIndemnity_2.htm', 'newwindow', 'height=1169, width=827, top=0,left=0, toolbar=no, menubar=no, scrollbars=yes, resizable=no,location=no, status=no');
		window.open ('Demo/ProposalIndemnity_2.htm', 'newwindow', 'height=1000, width=900, top=0,left=400, toolbar=no, menubar=no, resizable=no, scrollbars=yes');
		});
