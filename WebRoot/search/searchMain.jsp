...
$(function() { 
 ...
 /*Modernizr.load([{ both: [ '../js/NovaJS/jquery.min.js', '../js/NovaJS/modernizr/jquery.stackslider.js' ], 
		...
		<form>
			<div id="searchOption">
				<table>
					...
					<tr class=searchframe style="height:33px;">
						...
						<td><input type="button" id="searchBtn" style="border-left:3px solid #D3D3D4;border-right:3px solid #D3D3D4;" value="<i18n:message key='button.search'/>" onclick="document.getElementById('divTop').style.display='none';search2reflush()"> </td>
					</tr>
				</table>
			</div>
			<div id="policyList">
				...
				<div id="policySlide">
					...
					<table id="policyListTable" class="searchResultList interval_color"></table>
			...
			<div id="clientList">
				...
				<div id="clientSlide">
					...
					<table id="clientListTable" class="searchResultList interval_color"></table>
			...
			<div id="memberList">
				...
				<div id="memberSlide">
					...
					<table id="memberListTable" class="searchResultList interval_color"></table>
		    ...
		    用于添加baseview的div
					<section class="main">
											<ul id="st-stack" class="st-stack-raw">
												<li><div class="st-item"><div style="width:200px;height:200px;color:red"><p>abc1</p></div></div><div class="st-title"><h2>Graverobber</h2><h3>by Isaac Montemayor</h3></div></li>
												<li><div class="st-item"><div style="width:200px;height:200px;color:red"><p>abc2</p></div></div><div class="st-title"><h2>Hideous Snake Queen</h2><h3>by Isaac Montemayor</h3></div></li>
											</ul>
					</section>
			</div>  -->
			<IFRAME id="searchDetailIframe" name="searchDetailIframe" frameBorder="0"  src="" scrolling="no" style="HEIGHT: 100%; WIDTH: 100%;Z-INDEX: 1;overflow-y:hidden;">
...
<!-- 	<DIV class=sideCatalogBg>
	...
	<div>
		...
		<a class="sideCatalogBtn" title="<i18n:message key="common.policyOutline"/>" style="background: url(../images/AnchorMenu_Basic.gif)" href="javascript:void(0);" onclick="anchor(searchDetailIframe,1)"></a>
		<a class="sideCatalogBtn" title="<i18n:message key="common.policyBPOutline"/>" style="background: url(../images/AnchorMenu_Bill.gif)" href="javascript:void(0);" onclick="anchor(searchDetailIframe,2)"></a>
		<a class="sideCatalogBtn" title="<i18n:message key="common.claimsOutline"/>" style="background: url(../images/AnchorMenu_Claim.gif)" href="javascript:void(0);" onclick="anchor(searchDetailIframe,3)"></a>
